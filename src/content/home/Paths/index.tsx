...
export function Paths() {
  return (
    <div className="py-[80px] px-[16px] grid grid-cols-[repeat(auto-fill,minmax(140px,1fr))] gap-[30px] justify-center items-center bg-primary-500 border-b-[3px] border-b-secundary-500 lg:py-[96px] lg:px-[186px] lg:grid-cols-6 lg:grid-flow-row">
      {paths.map((atalho) => (
        <div
          key={atalho.text}
